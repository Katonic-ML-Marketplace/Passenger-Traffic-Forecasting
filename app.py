...
st.set_page_config(
    page_title='Passenger Traffic Forecasting App', 
    page_icon = im, 
    layout = 'wide', 
...
st.sidebar.title('Passenger Traffic Forecasting')
st.sidebar.write('---')

st.write("""
# Passenger Traffic Forecasting App

Passenger Traffic Forecasting **provides 30 weeks of forecast of passengers who are expected to travel 
using historical weekly passenger traffic data.**
""")
st.write('---')
...
# showing fig1
st.header('Passenger traffic with Date')
fig = px.line(data_df, x='ds', y='y')
fig.update_yaxes(title_text = 'Passenger Traffic')
...
if st.sidebar.button('Prediction'):
    ...
    st.header('Passenger Traffic Forecast')
